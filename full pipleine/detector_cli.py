#!/usr/bin/env python3
"""
VA / ST.ELLA Detector CLI v1.0 — standalone bridge
===================================================
...
ENGINE_VERSION = "1.0.0-universal-surface-rules"
SCHEMA_VERSION = "DETECTOR_OUTPUT_STANDALONE_V1"
...
def build_detector_output(submission: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "created_at": now_iso(),
        "detector_mode": "standalone_cli_universal_surface_rules",
