#!/usr/bin/env python3
"""
VA / ST.ELLA Gold Full Pipeline Orchestrator v1.4.4
==================================================
...
Typical usage:
python gold_full_pipeline_orchestrator_v1_4_4.py --input submission.json --engine-config gold_engine_commands.json --output-root gold_sessions --pretty

For development, you can copy existing artifacts instead of running engines:
python gold_full_pipeline_orchestrator_v1_4_4.py --input submission.json --copy-from-session previous_session_dir --output-root gold_sessions --pretty
"""
...
ENGINE_VERSION = "1.4.6-lret146-quality-gated-orchestration-only-standalone"
...
def validate_quality_gates(paths: Dict[str, Path]) -> List[Dict[str, str]]:
    ...
    # Coach/directive alignment is intentionally not a hard v1.4.4 gate.
    # Writing Coach may choose a prerequisite/dependency skill. This should be audited
    # by a later service-alignment release, but v1.4.6 focuses on scorer metadata and LRET routing with the new LRET algorithm.
