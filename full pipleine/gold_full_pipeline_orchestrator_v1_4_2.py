#!/usr/bin/env python3
"""
VA / ST.ELLA Gold Full Pipeline Orchestrator v1.4.2
==================================================
...
Typical usage:
python gold_full_pipeline_orchestrator_v1_4_2.py --input submission.json --engine-config gold_engine_commands.json --output-root gold_sessions --pretty

For development, you can copy existing artifacts instead of running engines:
python gold_full_pipeline_orchestrator_v1_4_2.py --input submission.json --copy-from-session previous_session_dir --output-root gold_sessions --pretty
"""
...
ENGINE_VERSION = "1.4.2-orchestration-only-standalone-path-resolution"
...
def main(argv: Optional[List[str]] = None) -> int:
    ap = argparse.ArgumentParser(description="Gold full pipeline orchestrator v1.4.2 — standalone orchestration only with safe engine path resolution.")
