#!/usr/bin/env python3
"""
vocab_coach_selection_engine_v1_3.py
=====================================
...
CLI (all v1_2 args unchanged; two new optional args added at the end):
    ...
    --evaluator PATH             (NEW v1_3, optional; raw 07_evaluator_output.json --
                                  the most recent essay's full Evaluator payload, NOT
                                  the trimmed evaluator_payload used elsewhere)
    --engagement-history PATH   (NEW v1_3, optional; output of
...
ENGINE_VERSION = "vocab-coach-selection-engine-v1.3"
